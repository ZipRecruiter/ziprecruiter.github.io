...
(function() {
  ...
  if ( window['--jira-helper-loaded'] ) return;
  window['--jira-helper-loaded'] = true;
  ...
  window.zrBookmarkletUrl = window.zrBaseUrl + "/greasemonkey/jira-helper";

  {% include js/vendor/autosize/3.0.10/autosize.js %}

  {% capture include_to_scssify %}
  	{% include greasemonkey/jira-helper/jira-helper.css %}
  {% endcapture %}

  window.zrBookmarkletCSS = {{ include_to_scssify | jsonify }};

  {% include greasemonkey/jira-helper/jira-helper-script.js %}
